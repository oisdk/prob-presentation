...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}(\bind )\mathbin{::}\Conid{Dist}\;\Varid{a}\to (\Varid{a}\to \Conid{Dist}\;\Varid{b})\to \Conid{Dist}\;\Varid{b}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{xs}\bind \Varid{f}\mathrel{=}\Conid{Dist}\;{}\<[18]%
\>[18]{}[\mskip1.5mu {}\<[18E]%
\>[21]{}(\Varid{y},\Varid{xp}\times\Varid{yp}){}\<[E]%
\\
\>[18]{}\mid {}\<[18E]%
\>[21]{}(\Varid{x},\Varid{xp})\leftarrow \Varid{runDist}\;\Varid{xs}{}\<[E]%
\\
\>[18]{},{}\<[18E]%
\>[21]{}(\Varid{y},\Varid{yp})\leftarrow \Varid{runDist}\;(\Varid{f}\;\Varid{x})\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\end{frame}
\begin{frame}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{guard}\mathbin{::}\Conid{Bool}\to \Conid{Dist}\;(){}\<[E]%
\\
\>[B]{}\Varid{guard}\;\Conid{True}{}\<[14]%
\>[14]{}\mathrel{=}\Conid{Dist}\;[\mskip1.5mu ((),\mathrm{1})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{guard}\;\Conid{False}{}\<[14]%
\>[14]{}\mathrel{=}\Conid{Dist}\;[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\end{frame}
\begin{frame}
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\Varid{return}\mathbin{::}\Varid{a}\to \Conid{Dist}\;\Varid{a}{}\<[E]%
\\
\>[3]{}\Varid{return}\;\Varid{x}\mathrel{=}\Conid{Dist}\;[\mskip1.5mu (\Varid{x},\mathrm{1})\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\end{frame}
\begin{frame}
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{mrSmith}\mathbin{::}\Conid{Dist}\;[\mskip1.5mu \Conid{Child}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{mrSmith}\mathrel{=}\textcolor{BlueViolet}{\textbf{do}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{child1}\leftarrow \Varid{child}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{child2}\leftarrow \Varid{child}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{guard}\;(\Varid{gender}\;\Varid{child1}\equiv \Conid{Boy}\mathrel{\vee}\Varid{gender}\;\Varid{child2}\equiv \Conid{Boy}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{return}\;[\mskip1.5mu \Varid{child1},\Varid{child2}\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{expect}\mathbin{::}(\Varid{a}\to \Conid{Rational})\to \Conid{Dist}\;\Varid{a}\to \Conid{Rational}{}\<[E]%
\\
\>[B]{}\Varid{expect}\;\Varid{p}\;\Varid{xs}\mathrel{=}\frac{\Varid{sum}\;[\mskip1.5mu \Varid{p}\;\Varid{x}\times\Varid{xp}\mid (\Varid{x},\Varid{xp})\leftarrow \Varid{runDist}\;\Varid{xs}\mskip1.5mu]}{\Varid{sum}\;[\mskip1.5mu \Varid{xp}\mid (\anonymous ,\Varid{xp})\leftarrow \Varid{runDist}\;\Varid{xs}\mskip1.5mu]}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\end{frame}
\begin{frame}

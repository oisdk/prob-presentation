...
/* package probabilitypresentation-1.0 */
#define VERSION_probabilitypresentation "1.0"
#define MIN_VERSION_probabilitypresentation(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
...
#define CURRENT_COMPONENT_ID "probabilitypresentation-1.0"

#define CURRENT_PACKAGE_KEY "probabilitypresentation-1.0"
